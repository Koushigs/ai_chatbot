...
def get_date_panchang(date: str = None, data_language: str = "EN") -> str:
    ...
    try:
        ...
        url = f"https://api.exaweb.in:3004/api/panchang/daily?date={api_date}&applanguage=EN&datalanguage={data_language}"
        
        headers = {"apikey": "anvlbharatcal123"}
...
def get_holidays(year: int = None, data_language: str = "EN") -> str:
    ...
    params = {"datalanguage": data_language, "year": year}
    headers = {"apikey": "anvlbharatcal123"}
...
def get_monthly_festivals(year: Optional[int] = None, month: Optional[str] = None, data_language: str = "EN") -> str:
    ...
    params = {"year": year, "month": month, "datalanguage": data_language}
    headers = {"apikey": "anvlbharatcal123"}
