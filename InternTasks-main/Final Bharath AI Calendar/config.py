...
KUNDALI_PDF_API = os.getenv("KUNDALI_PDF_API", "https://api.bharatcalendars.in:8443/api/kundali/generate-pdf")
JANMARASHI_API = os.getenv("JANMARASHI_API", "https://api.bharatcalendars.in:8443/api/janamrashi/moon-rashi")
